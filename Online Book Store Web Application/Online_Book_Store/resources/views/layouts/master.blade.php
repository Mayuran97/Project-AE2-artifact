...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{asset('/')}}assets/img/logo1.JPG" type="image/x-icon">
    <!-- Font Awesome -->
...
<section class="header py-2 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="headings">
                    <h3><a href="{{route('bookshop.home')}}" class="text-secondary"><b class="text-danger">Online</b> BookStore</a></h3>
                </div>
            </div>
            <div class="col-md-4">
                <form action="{{route('all-books')}}">
                    <div class="input-group input-group-sm m-1">
                        <input type="text" name="term" value="{{request('term')}}" class="form-control" placeholder="Here Search Any Book..">
...
<footer class="py-3 text-center border-top bg-light">
    <div class="container">
        ...
        <div class="footer-text">
            Copyright &copy; M.Mayuran - <span id="year"></span>
        </div>
        </div>
    </div>
</footer>
