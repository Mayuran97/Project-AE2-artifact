        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="billing-address my-4">
                    <div class="p-3 bg-light my-4"><h4 class="m-0">Shipping address</h4></div>
                ...
                <div class="cart-summary my-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Product Cost = {{Cart::total()}} LKR</p>
                            <p>Shipping cost = 0.00 LKR</p>
                            <p><strong>Total cost = {{Cart::total()}} LKR</strong></p>
                        </div>
                    </div>
                </div>
            </div>
